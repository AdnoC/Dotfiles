% Based on A.tex used to generate and downloadable from http://web.ift.uib.no/Teori/KURS/WRK/TeX/symALL.html
%
% To generate a txt file from this:
% 1. latex tex_symbols.tex
% 2. catdvi tex_symbols.dvi
...
\begin{table}
\begin{tabular}{*8l}
  \W\mathbb{N}    &\W\mathbb{Z}    &\W\mathbb{Q}    &\W\mathbb{a} \\
  \W\mathbb{R}    &\W\mathbb{C}     &\W\mathbb{H}   &\W\mathbb{O}
\end{tabular}

\caption{Math Sets}\label{msets}
\end{table}
